...
\subsection{Studies}
The experiment is similar with Carlson experiment, studies were conducted;


\subsubsection{Study 1}
The aim of this study is to examine if prospective memory failure happen if a person uses a smartphone.
one question presented at a time.

\subsubsection{Study 2}
the aim of this study is to examine if increasing number of intention  (intentional loads matter)
one or two questions presented at a time.

\subsubsection{Study 3}

one question presented at a time, every time a participant look at the question he/she was instructed to move to another the room.
...
21 Participants participated in the study. three participants were pilot testers, while 18 student participate
as experimenter. All of the experimenter are student from University of Edinburgh.
The participant consist 4 women and 13 men. The age of participants are beween 21 to 27 years old.
four experimenters were participate on the first study. 11 experimenters participate on the second study,
and the remaining three experimenter participate on the third study.
...
\todo[inline]{explain how carlson implemeted the study, pake analytis}
...
\begin{table}[!tbh]
  ...
  \footnotesize
  \centering
\begin{tabu}{ |X[0.5,l]|X[5.5,l]|X[1.6,l]|X[7,l]|  }
 \hline
