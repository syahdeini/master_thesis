...
\begin{tabu}{|X[0.5,l]|X[5,l]   |X[2.3,l]|X[6,l]|  }
 ...
 7 & randomGenerator & Random  & This is a random class that use to generate a random number, it is used inside changeNumberPresentedQuestion method \\ \hline
\end{tabu} \par
...
\begin{table}[!tbh]
 ...
 7 & representId & string  &  the random id generated when the question is presented during the quiz.\\ \hline
...
Then the JSON object compiled into The \textit{Study} object. This object controls the quiz experiment and hold all the data, including the track variables.
